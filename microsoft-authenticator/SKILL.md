...
description: 注册“Microsoft Authenticator”技能；用于工具类产品公开页面、功能说明、下载入口与帮助信息整理。
homepage: `https://www.microsoft.com/security/mobile-authenticator-app`
...
- 主页：https://www.microsoft.com/security/mobile-authenticator-app
...
- 版本整理：访问 Microsoft Authenticator 下载页 → 提取平台与版本入口 → 输出清单
